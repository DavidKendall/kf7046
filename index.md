...
**6** | 19-Feb &nbsp; | [Case study: DNS and Bind]({{site.raurl}}/A06.pdf) | [Seconday DNS server: load-balancing and logging](L06.html) | [A layered naming architecture for the Internet]({{site.raurl}}/blr04.pdf) <br/> [RFC 1034](http://tools.ietf.org/html/rfc1034), [RFC 1035](http://tools.ietf.org/html/rfc1035)
...
**9** | 12-Mar &nbsp; | [Software defined networking]({{site.raurl}}/A09.pdf) | [Introduction to Mininet](L09.html) | [A network in a laptop: rapid prototyping for software defined networks]({{site.raurl}}/lhm10.pdf) <br/> [Onix: a distributed control platform for large-scale production networks]({{site.raurl}}/kcg10.pdf) <br/> [The future of networking and the past of protocols](http://www.youtube.com/watch?v=YHeyuD89n1Y) (video)
